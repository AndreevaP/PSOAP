...
### *Цель работы*: Собрать информацию о топ 15 доменах в одной из категорий (Consultants ( 954 ))
...
urls <- c("Connectwise.com", "Syntax.co.uk", "Infotivity.com", "Aitbusiness.com", "Generalcode.com", "Cull.co.uk",              "Incognito.com", "Enterprisemanagement.com", "Airosgroup.com", "Cybercity.nyc", "Easysoft.com", "Scguild.com", "Linbit.com", "Digibel.be", 	"Rand.com")
...
```{r, cache=TRUE}
library(rappalyzer)
rappalyze("Connectwise.com")
rappalyze("Syntax.co.uk")
rappalyze("Infotivity.com")
rappalyze("Aitbusiness.com")
rappalyze("Generalcode.com")
rappalyze("Cull.co.uk")
rappalyze("Incognito.com")
rappalyze("Enterprisemanagement.com")
rappalyze("Airosgroup.com")
rappalyze("Cybercity.nyc")
rappalyze("Easysoft.com")
rappalyze("Scguild.com")
rappalyze("Linbit.com")
rappalyze("Digibel.be")
rappalyze("Rand.com")
```
